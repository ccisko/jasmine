...
$(function() {
    ...
    describe('Initial Entries', function() {
        ...
        /* 1. TODO: Write a test that ensures when the loadFeed
        ...
        it('When loadfeed completes should be atleast 1 entry', function() {
            expect($('ul').hasClass('feed-list')).toBe(true);
    ...
    describe('New Feed Selection', function() {
        ...
        var feedOne = $("entry-link:nth-child(1)").contents();
        var feedTwo = $("entry-link:nth-child(2)").contents();
